...
namespace Parcial3
{
    class CVertice
    {
        ...
        public List<CArista> ListaAdyacencia; // Lista de adyacencia del nodo
        Dictionary<string, short> _banderas;
        Dictionary<string, short> _banderas_predeterminado;
        public bool Visitado; //para determinar si ya fue visitado en los recorridos
                              // Propiedades
        public Color Color
        {
        ...
        public void DibujarArco(Graphics g)
        {
            float distancia;
            int difY, difX;
            foreach (CArista arco in ListaAdyacencia)
            {
